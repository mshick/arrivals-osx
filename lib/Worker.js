...
const AUDIO_CONVERSION_EXTENSION_LIST = process.env.AUDIO_CONVERT_EXTENSIONS.split(",");
const AUDIO_COPY_EXTENSION_LIST = process.env.AUDIO_COPY_EXTENSIONS.split(",");
const VIDEO_CONVERSION_EXTENSION_LIST = process.env.VIDEO_CONVERT_EXTENSIONS.split(",");
const VIDEO_COPY_EXTENSION_LIST = process.env.VIDEO_COPY_EXTENSIONS.split(",");
